...
(ert-deftest test-nrepl-bdecode-list-of-ints ()
  (should (equal '(((dict 1 2 3 4) 5 6 (7 8)))
                 (nrepl-bdecode-string "ldi1ei2ei3ei4eei5ei6eli7ei8eee"))))
...
(ert-deftest test-nrepl-bdecode-nrepl-doc-output ()
  (should (equal '(((dict
                    ...
                    (dict
                     ...
                     "session" "6fc999d0-3795-4d51-85fc-ccca7537ee57"
                     "status" ("done"))))
                 (nrepl-bdecode-string "ld2:id2:183:out20:clojure.core/reduce
...
(ert-deftest test-nrepl-bdecode-nrepl-doc-output-2 ()
  (should (equal (cons
                  ...
                  [cl-struct-nrepl-response-queue
                   ...
                   ((dict "id" "18"
                          ...
                          "status" ("done")))
                   nil])
                 (nrepl-bdecode "d2:id2:183:out20:clojure.core/reduce
7:session36:6fc999d0-3795-4d51-85fc-ccca7537ee57ed2:id2:183:out24:([f coll] [f val coll])
7:session36:6fc999d0-3795-4d51-85fc-ccca7537ee57ed2:id2:183:out588:  f should be a function of 2 arguments. If val is not supplied,
  returns the result of applying f to the first 2 items in coll, then
  applying f to that result and the 3rd item, etc. If coll contains no
...
(ert-deftest test-nrepl-bdecode-dict-partial ()
  (should (equal '((dict "spam" "moo" "cow"))
                 (nrepl-bdecode-string  "d3:cow3:moo4:spam4:eg"))))

(ert-deftest test-nrepl-bdecode-dict-partial-2 ()
  (should (equal '((dict "spam" "moo" "cow"))
                 (nrepl-bdecode-string  "d3:cow3:moo4:spam4:"))))

(ert-deftest test-nrepl-bdecode-list-of-ints-partial ()
  (should (equal '((6 5 (dict 1 2 3 4)))
                 (nrepl-bdecode-string "ldi1ei2ei3ei4eei5ei6ei"))))

(ert-deftest test-nrepl-bdecode-split-strings ()
  (should (equal '((dict
                    "ns" "user"
                    "session" "20c51458-911e-47ec-97c2-c509aed95b12"
                    "value" "2"))
                 (nrepl-bdecode-strings
                  "d2:ns4:user7:sess"
                  "ion36:20c51458-911e-47ec"
                  "-97c2-c509ae"
                  "d95b125:value1:2e"))))

(ert-deftest test-nrepl-bdecode-nrepl-split-doc-output ()
  (should (equal '((dict
                    "id" "18"
                    "out" "clojure.core/reduce\n"
                    "session" "6fc999d0-3795-4d51-85fc-ccca7537ee57")
                   ...
                   (dict
                    ...
                    "session" "6fc999d0-3795-4d51-85fc-ccca7537ee57"
                    "status" ("done")))
                 (nrepl-bdecode-strings "d2:id2:183:out20:clojure.core/"
                                       "reduce
7:session36:6fc999d0-3795-4d51-85fc-ccca7537ee57ed2:id2:183:out24:([f coll] [f val coll])
7:session36:6fc999d0-3795-4d51-85fc-ccca7537ee57ed2:id2:183:out588:  f should be a function of 2 arguments. If val is not supplied,
...
(defvar nrepl--toString-dicts
  '((dict "id" "29" "session" "9bde8b1f-aefc-4883-aa7c-9c3fa4692ac2" "value"
          (dict "candidates"
...
(ert-deftest test-nrepl-bdecode-nrepl-split-toString-doc-output ()
  ;; If we blow this depths, we are doing something utterly wrong:
  (let ((max-lisp-eval-depth 100)
        (max-specpdl-size 100))
    (should (equal nrepl--toString-dicts
                   (apply 'nrepl-bdecode-strings nrepl--toString-strings)))))

(ert-deftest test-nrepl-bdecode-with-queues ()
  (should (equal (cons
                  [cl-struct-queue nil nil]
                  [cl-struct-nrepl-response-queue (((1 2 3) (5 6))) (((1 2 3) (5 6))) nil])
                 (nrepl-bdecode "lli1ei2ei3eeli5ei6eee"))))

(ert-deftest test-nrepl-bdecode-with-queues-partial-1 ()
  (should (equal (cons
                  [cl-struct-queue ("i6") ("i6")]
                  [cl-struct-nrepl-response-queue (((1 2 3) (5 6))) (((1 2 3) (5 6)))
                                            ((5) ((1 2 3)))])
                 (nrepl-bdecode "lli1ei2ei3eeli5ei6eeelli1ei2ei3eeli5ei6"))))


;; idempotence 

(ert-deftest test-nrepl-bencode-idempotence ()
  (let ((obj '(dict
               "int" 1
               "int-list" (1 2 3 4 5)
               ...
               "status" ("eval-error"))))
    (should (equal obj (car (nrepl-bdecode-string (nrepl-bencode obj)))))))
